...
\begin{table}[htbp]
	...
	\caption{DSDM-Arm Joint Specifications}
		\begin{tabular}{ c c c c c c c c }
			\hline
			   & Range  & \multicolumn{2}{c}{Max. Velocity} & \multicolumn{2}{c}{Max. Torque} & \multicolumn{2}{c}{Reflected Rotor Inertia} \\
