...
\begin{figure}[htp]
	\centering
		\includegraphics[width=0.45\textwidth]{dsdm_proto_2.jpg}
	\caption{Two-speed actuator prototype. Max continuous torque of 40 Nm and maximum velocity of 100 RPM}
	\label{fig:dsdm_cad}
\end{figure}
