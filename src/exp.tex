...
\begin{figure}[htp]
	...
	\caption{Linear actuator assembly in a preliminary tests configuration} 
	\label{fig:linact}
\end{figure}
...
The linear actuator assembly was initially designed as an experimental test bench for the DSDM technology \cite{girard_two-speed_2015}. Unlike the revolute actuators, the transmission is sealed and lubricated with oil and flexible coupling are used to connect all the components.  The linear actuator is thus more heavy duty, but bigger and heavier. However, this assembly is fixed to the ground and not a moving part of the DSDM-Arm, hence drawback of weight and volume are limited. 
