...
%\end{align}
%
The equation of motion can then be rearranged in the standard manipulator equation form, using $w_o$ and $w_1$ are generalized coordinates:
%
\begin{align}
\underbrace{ 
\left[
