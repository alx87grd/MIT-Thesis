...
Continuously variable transmission have been used sporadically for car power-trains. Most common design are based on belts with variable-diameter pulley or toroidal. Drawbacks compared to regular transmission include higher transmission losses and complex dynamics \cite{srivastava_review_2009}. Moreover, typical CVT total ratio variation are limited to about a factor 3 (for instance 1:1 to 3:1), which makes them unadapted for large ratio variation. Some design were proposed for infinite range variation, often called IVT. For instance the company Torotrack claim to have a CVT that can reach an effective gear-ratio of zero \cite{fellows_continuously-variable-ratio-transmissions_1996}. However, since those designs rely on friction, maximum transmitted torque is limited and the transmission systems are complex and very large, which inhibit the potential use in robotic applications.  
