...
\subsubsection{Up-shift: From high-force mode to high-speed mode}
...
\subsubsection{Down-shift: From high-speed mode to high-force mode}
...
\subsubsection{Synchronization control algorithm}
