...
\begin{align}
\tau_1 = \tau \quad \tau_2 = 0    \quad \text{if} k=0 \\
\tau_1 = 0    \quad \tau_2 = \tau \quad \text{if} k=1
\end{align}

Then the equation of motions for each operating mode are:


and they can be reduced the same structure :


where only the gear-ratio is different. This would thus be equivalent to the system illustrated at Fig. XX, and the corresponding equation of motion:
