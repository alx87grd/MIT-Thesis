...
\begin{figure}[htp]
	\centering
		\includegraphics[width=0.6\textwidth]{EM_two.png}
	\caption{Force-speed curve of two-speed electric motor using flux weakening}
	\label{fig:EM_two}
\end{figure}
