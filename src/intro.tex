...
On the other hand, for car power-train the driven load is always a large inertia and is thus naturally attenuating any discontinuity in torque during a gear-shift. However, this is not the case in a general robotic context. 
...
\begin{align}
	\text{Car} \quad R \in \{3,2,1.4,1,0.8\} \quad \quad 
	\text{Robot with VGA} \quad R \in 
	\left \{ 
	\begin{array}{c}
	\left[
	\begin{array}{c}
