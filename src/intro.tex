...
\paragraph{Software}
%
A \emph{Python} library providing tools for planning trajectory, controlling and simulating the behavior of robots using VGA, and implementing all proposed novel controllers was developed \cite{girard_github.com/alx87grd/alexrobotics_2017}. Additionally, ROS wrappers to use those algorithms online to control prototypes were also developped \cite{girard_github.com/alx87grd/dsdm_robotics_ros_2017}.
