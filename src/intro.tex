...
This thesis was invention-driven, focusing on demonstrating the viability and advantages of robotic systems using variable transmissions. 

\subsection{Prototypes}

Two generations of \emph{DSDM actuator prototypes} were designed, manufactured and tested. The first generation DSDM prototype consist of a linear actuator using a ball-screw output. The second generation consist of two actuated revolute joint equipped with the DSDM technology. 

A \emph{custom light-weight 3-DoF robotic arm} using the DSDM actuator prototypes and all the proposed control algorithms in its control software was developed. 

A \emph{climbing robot prototype} demonstrating a manufacturing robot solution concept motivating the need for VGA actuators was also designed, manufactured and tested.
...
Demonstration of fast gear-shifts in many dynamic situations
