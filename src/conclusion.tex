...
%
Chapter \ref{sec:ExperimentalValidation} presented the DSDM-Arm, a novel lightweight robotic system using three DSDM actuators, which was used for experimental validation of all the proposed control schemes. %The DSDM-Arm mechanical design, control implementation and specifications were discussed. 
